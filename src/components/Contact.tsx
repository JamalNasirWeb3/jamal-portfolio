const contactLinks = [
  {
    label: "Email",
    value: "jfk24572@gmail.com",
    href: "mailto:jfk24572@gmail.com",
    icon: (
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/jamal-abdul-nasir",
    href: "www.linkedin.com/in/jamal-nasir-isloo",
          ...
          <div className="flex flex-col gap-5">
            {contactLinks.map((link) => (
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl border border-white/5 bg-zinc-800/50 hover:border-indigo-500/30 hover:bg-zinc-800 transition-colors group"
              >
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-zinc-800 border border-white/5 text-white text-sm placeholder-zinc-600 focus:outline-none focus:border-indigo-500/50 transition-colors"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-zinc-800 border border-white/5 text-white text-sm placeholder-zinc-600 focus:outline-none focus:border-indigo-500/50 transition-colors resize-none"
              />
            </div>
            <button
              type="submit"
